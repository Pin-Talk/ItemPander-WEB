    ...
    <div>
      ...
      <div className='flex flex-col space-y-2'>
        <input
          ...
          className='caret-white p-1 px-2 lg:p-2 rounded-md bg-transparent border-2 border-gray-200 w-50 cursor-pointer'
          type='text'
          placeholder='통합 주소'
          value={address}
        />
        <textarea
          placeholder='상세주소'
          className='outline-none p-1 px-2 lg:p-2 rounded-md bg-transparent border-2 border-gray-200 w-50'
        />
      </div>
    </div>
  );
